  ...
  return (
    < section className=" w-full py-20" >
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
        ...
        description=" 'It collaborate to map out your
website's goals,
target audience, and key
functionalities.
We' It discuss things like
site structure,
...
requirements."
        ...
        description="we agree on the plan, I cue
my tofi playlist and dive into coding. From
  ...
  return (
    ...
    >
      ...
      <div className="relative z-20">
        <div className="text-center group-hover/canvas-card:-translate-y-4   top-[50%] left-[50%] translate-y-[-50%] translate-x-[-50%] absolute group-hover/canvas-card:opacity-0 transition duration-200 w-full  mx-auto flex items-center justify-center">
          {icon}
        </div>
